          ...
          <motion.div
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 0 1px rgba(255,255,255,0.04), 0 32px 80px rgba(0,0,0,0.7), 0 0 100px rgba(99,102,241,0.07)",
              }}>
                ...
                {done ? (
                  ...
                  <motion.div key="form" initial={{ opacity: 1 }} exit={{ opacity: 0 }}>
                    ...
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <h2 className="text-lg font-bold text-white leading-tight">Create your account</h2>
                        <p className="text-xs text-gray-600">1 free check included · No credit card required</p>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-3">
                      ...
                      {/* Name */}
                      <div>
                        <label className="block text-[11px] font-medium text-gray-600 mb-1 uppercase tracking-wider">Full name</label>
                        <input
                          type="text"
                          value={name}
                      ...
                      {/* Email */}
                      <div>
                        <label className="block text-[11px] font-medium text-gray-600 mb-1 uppercase tracking-wider">Email</label>
                        <input
                          type="email"
                          value={email}
                      ...
                      {/* Password */}
                      <div>
                        <label className="block text-[11px] font-medium text-gray-600 mb-1 uppercase tracking-wider">Password</label>
