...
const en: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What's the difference between Starter, Personal, and Pro?", a: "Starter is pay-per-use at $2.99/check — full report, no subscription. Personal ($19.99/mo) includes 10 full checks per month. Pro ($39.99/mo) includes 50 checks per month. All plans include the full trust score breakdown, verdict, return risk, red flags, and price comparison." },
      { q: "Are my reports saved after the check?", a: "Starter reports are full but not saved to your history. Personal and Pro subscribers can access their full report history from the dashboard at any time." },
...
const fr: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Quelle est la différence entre Starter, Personnel et Pro ?", a: "Starter est à 2,99 $/analyse — rapport complet, sans abonnement. Personnel (19,99 $/mois) inclut 10 analyses complètes par mois. Pro (39,99 $/mois) inclut 50 analyses par mois. Tous les plans incluent le rapport de confiance complet, le verdict, le risque de retour, les signaux d'alerte et la comparaison de prix." },
      { q: "Mes rapports sont-ils sauvegardés après la vérification ?", a: "Les rapports Starter sont complets mais non sauvegardés dans l'historique. Les abonnés Personnel et Pro peuvent accéder à tout leur historique de rapports depuis le tableau de bord à tout moment." },
...
const de: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Was ist der Unterschied zwischen Starter, Persönlich und Pro?", a: "Starter kostet 2,99 $ pro Check — vollständiger Bericht, kein Abonnement. Persönlich (19,99 $/Monat) enthält 10 vollständige Checks pro Monat. Pro (39,99 $/Monat) enthält 50 Checks pro Monat. Alle Pläne beinhalten vollständige Vertrauensbewertung, Urteil, Rückgaberisiko, Warnzeichen und Preisvergleich." },
      { q: "Werden meine Berichte nach der Prüfung gespeichert?", a: "Starter-Berichte sind vollständig, werden aber nicht im Verlauf gespeichert. Persönlich- und Pro-Abonnenten können ihren vollständigen Berichtsverlauf jederzeit über das Dashboard abrufen." },
...
const es: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "¿Cuál es la diferencia entre Starter, Personal y Pro?", a: "Starter es de pago por uso a $2,99/verificación — informe completo, sin suscripción. Personal ($19,99/mes) incluye 10 verificaciones completas al mes. Pro ($39,99/mes) incluye 50 verificaciones al mes. Todos los planes incluyen el desglose completo de confianza, veredicto, riesgo de devolución, señales de alerta y comparación de precios." },
      { q: "¿Se guardan mis informes después de la verificación?", a: "Los informes Starter son completos pero no se guardan en el historial. Los suscriptores Personal y Pro pueden acceder a su historial completo de informes desde el panel de control en cualquier momento." },
...
const pt: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Qual é a diferença entre Starter, Personal e Pro?", a: "Starter é pague por uso a $2,99/verificação — relatório completo, sem assinatura. Personal ($19,99/mês) inclui 10 verificações completas por mês. Pro ($39,99/mês) inclui 50 verificações por mês. Todos os planos incluem análise de confiança completa, veredicto, risco de devolução, sinais de alerta e comparação de preços." },
      { q: "Meus relatórios são salvos após a verificação?", a: "Os relatórios Starter são completos mas não salvos no histórico. Assinantes Personal e Pro podem acessar todo o histórico de relatórios no painel a qualquer momento." },
...
const it: Translations = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Qual è la differenza tra Starter, Personal e Pro?", a: "Starter è a pagamento per utilizzo a $2,99/verifica — report completo, senza abbonamento. Personal ($19,99/mese) include 10 verifiche complete al mese. Pro ($39,99/mese) include 50 verifiche al mese. Tutti i piani includono analisi di fiducia completa, verdetto, rischio di reso, segnali di allerta e confronto prezzi." },
      { q: "I miei report vengono salvati dopo la verifica?", a: "I report Starter sono completi ma non vengono salvati nella cronologia. Gli abbonati Personal e Pro possono accedere all'intera cronologia dei report dalla dashboard in qualsiasi momento." },
